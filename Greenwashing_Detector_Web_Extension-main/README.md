...
Built a Flask-based backend API that extracts website content, performs automated claim analysis, generates downloadable audit-style reports, and supports real-time interaction with a browser extension.

Integrated fact-checking logic, text preprocessing, and report generation, enabling transparent evaluation of environmental claims and improving user awareness of misleading sustainability practices.
